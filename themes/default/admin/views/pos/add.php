                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 col-sm-offset-1">
                                            <div class="form-group">
                                                ...
                                                <label>( 1$ = <?php echo number_format($currency->rate,0); ?>៛ ) </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-5 col-sm-offset-1 hide">
                                            <div class="form-group">
                        ...
                        <div class="font16">
                            <table class="table table-bordered table-condensed table-striped" style="margin-bottom: 0;">
                                ...
                                <tr>
                                    ...
                                    <td><span id="total_payable_r">0.00</span><span><?php if($Settings->default_currency=="USD"){echo "៛";}else{echo "USD";}?></span></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><span id="balance_r">0.00</span><span><?php if($Settings->default_currency=="USD"){echo "៛";}else{echo "USD";}?></span></td>
                                </tr>
                                </tbody>
                            </table>
                            <div class="clearfix"></div>
...
<?php if ($this->input->get('customer')) {
        ...
        $(document).on('focus', '.amount-backup', function () {
            pi = $(this).attr('id');
            calculateTotals();
        ...
        function calculateTotalsBackup() {
            var total_paying = 0;
            var ia = $(".amount");
            $.each(ia, function (i) {
                var this_amount = formatCNum($(this).val() ? $(this).val() : 0);
