                        ...
                        if ($Owner || $Admin) {
                            ...
                            <?php if ($Owner) {
                                ...
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    ...
                                    ?>
                                        ...
                                        <li id="system_settings_warehouses" class = "hide">
                                        ...
                                        <li id="site_logs_index" class = "hide">
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <?php if (POS) {
                                ?>
                                    <li id="reports_register" class = "hide">
                                ...
                                ?>
                                    ...
                                    <li id="reports_daily_purchases" class = "hide">
                                    ...
                                    <li id="reports_staff_report" class = "hide">
