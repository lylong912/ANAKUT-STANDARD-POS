                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            foreach ($rooms as $room) {
                                                $roomArr[$room['id']] = $room['room_number'];
                                            }
                                            echo form_dropdown('room', $roomArr, (isset($_POST['room']) ? $_POST['room'] : $inv->room_id), 'id="room" disabled data-placeholder="' . lang('select') . ' ' . lang('room') . '"  class="form-control input-tip select" style="width:100%;"'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang('customer_contact', 'customer_contact'); ?>
                                            <?php echo form_input('customer_contact', (isset($_POST['customer_contact']) ? $_POST['customer_contact'] : $inv->customer_contact), 'class="form-control input-tip customer_contact" id="customer_contact" disabled '); ?>
                                        </div>
                                    </div>
